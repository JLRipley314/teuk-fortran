...
implicit none
   ...
   real(rp), parameter :: evolve_time = 0.2_rp
   integer(ip), parameter :: num_saved_times = 2_ip
   ...
   real(rp), parameter :: scd_order_start_time = 3.4274023475239845_rp
   ...
   integer(ip), parameter :: nt = 409_ip
   integer(ip), parameter :: t_step_save = 204_ip
   ...
   character(*), parameter :: output_stem = 'Oct__2_m0.5_s0.499_nx192_nl36'
   character(*), parameter :: output_dir = 'output/Oct__2_m0.5_s0.499_nx192_nl36'
   character(*), parameter :: bin_name = 'Oct__2_m0.5_s0.499_nx192_nl36.run'
   character(*), parameter :: tables_dir = 'output/Oct__2_m0.5_s0.499_nx192_nl36/tables'
