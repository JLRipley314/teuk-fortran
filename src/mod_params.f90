...
implicit none
   ...
   real(rp), parameter :: amp_re_pm1 = 0.4_rp
   ...
   real(rp), parameter :: amp_re_pm2 = 0.1_rp
   real(rp), parameter :: amp_im_pm2 = 0.0_rp
   real(rp), parameter :: rl_pm2_0 = 1.1_rp
   real(rp), parameter :: ru_pm2_0 = 2.5_rp
   ...
   real(rp), parameter :: rl_nm2_0 = 1.1_rp
   real(rp), parameter :: ru_nm2_0 = 2.5_rp
   integer(ip), dimension(4), parameter :: lin_m = [2_ip,3_ip,-3_ip,-2_ip]
   integer(ip), dimension(5), parameter :: scd_m = [0_ip,1_ip,5_ip,-5_ip,-1_ip]
   integer(ip), dimension(4), parameter :: lin_write_m = [2_ip,3_ip,-3_ip,-2_ip]
   integer(ip), dimension(5), parameter :: scd_write_m = [0_ip,1_ip,5_ip,-5_ip,-1_ip]
   ...
   real(rp), parameter :: rl_pm1 = 0.9427785635698568_rp
   real(rp), parameter :: ru_pm1 = 2.142678553567856_rp
   real(rp), parameter :: rl_nm1 = 0.9427785635698568_rp
   real(rp), parameter :: ru_nm1 = 2.142678553567856_rp
   real(rp), parameter :: rl_pm2 = 0.9427785635698568_rp
   real(rp), parameter :: ru_pm2 = 2.142678553567856_rp
   real(rp), parameter :: rl_nm2 = 0.9427785635698568_rp
   real(rp), parameter :: ru_nm2 = 2.142678553567856_rp
   ...
   integer(ip), parameter :: len_scd_m = 5_ip
   integer(ip), parameter :: len_lin_write_m = 4_ip
   integer(ip), parameter :: len_scd_write_m = 5_ip
   integer(ip), parameter :: num_threads = 2_ip
   integer(ip), parameter :: ny = 44_ip
